...
class RobotoStyle {
  ...
  static double title1FontSize = 62.h;
  static double title1FontHeight = 80 / title1FontSize;
  ...
  static double title2FontSize = 56.h;
  static double title2FontHeight = 64 / title2FontSize;
  ...
  static double headlineFontSize = 47.h;
  static double headlineFontHeight = 56 / headlineFontSize;
  ...
  static double bodyFontSize = 32.h;
  static double bodyFontHeight = 36 / bodyFontSize;
  ...
  static double descriptionFontSize = 26.h;
  static double descriptionFontHeight = 28 / descriptionFontSize;
  ...
  static double smallFontSize = 24.h;
  static double smallFontHeight = 28 / smallFontSize;
  ...
  static double microFontSize = 18.h;
  static double microFontHeight = 24 / microFontSize;
