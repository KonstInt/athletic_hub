...
class FilterBlocModel with _$FilterBlocModel {
  const factory FilterBlocModel(
      {required String id,
      required String title,
      required List<FilterModel> filters}) = _FilterModel;
  factory FilterBlocModel.fromJson(Map<String, dynamic> json) =>
      _$FilterBlocModelFromJson(json);
}
